        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row bg-title">
                    <div class="col-md-12">
                        <h4 class="page-title">Global statistics</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <div class="row">
                                <div class="col-md-2">
                                    <h2>Weeks statistics</h2>
                                    {{with .WeeksStatistics}}
                                        <table class="table">
                                            <tr>
                                                <td>Open</td>
                                                <td>{{.Summary.Open}}</td>
                                ...
                                <div class="col-md-10">
                                    <div id="chartWeeks" style="width: 100%; height: 700px;"></div>
                                    <script>
                                        var chart = AmCharts.makeChart("chartWeeks", {
                                            "type": "serial",
                                            "theme": "light",
                                            "marginRight": 40,
                                            "marginLeft": 40,
